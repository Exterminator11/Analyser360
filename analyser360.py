...
class analyserApp(MDApp):
    ...
    def __init__(self, **kwargs):
        ...
        l=['Word document','PDF']
        menu_items=[{'text':f'{i}','viewclass':'OneLineListItem','on_release':lambda x=f'{i}':self.do(x),}for i in l]
        self.menu=MDDropdownMenu(caller=self.screen.ids.button,items=menu_items,width_mult=2,)
